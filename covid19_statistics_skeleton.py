...
sum_people = 0
for i in n_people:
    sum_people = sum_people + i # TODO: The total number of people
sum_covid  = 0
for i in n_covid:
    sum_covid = sum_covid + i # TODO: The total number of new cases
...
for idx, covid in enumerate(n_covid):
    ...
    casePer1M = covid / n_people[idx] * 1000000
    print('| %s | %d | %.1f | %.1f |' % (regions[idx], covid, ratio, casePer1M))
print('')